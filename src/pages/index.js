...
const CountExample = () => (
  <section className="font-sans text-black">
    ...
    <div className="px-4 md:w-5/6 max-w-4xl md:mx-auto">
      ...
      <p className="mb-8">Uses custom browser events to send messages between two separate Elm apps embedded on the same page. You can checkout the code for this example in this <Link className="underline hover:no-underline" to="https://github.com/wking-io/elm-to-elm">Github Repo</Link></p>
